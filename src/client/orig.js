...
class App extends Component {
  ...
  initGame = () => {
    ...
    document.addEventListener('click', e => {
      ...
      if (this.state.gameStarted && this.state.countdownFinished)
        this.wordTypeInput.focus()
    })
  }
  ...
  updateHighScore = () => {
    if (localStorage.wordBeaterStats) {
      ...
      const newHighScore =
        this.state.score > highScore ? this.state.score : highScore
      ...
      <React.Fragment>
        {isLoaded ? (
          <div className={isLoaded ? 'beater fadeIn' : 'beater'}>
            <Music audioHandler={this.audioHandler} audioMuted={audioMuted} />
